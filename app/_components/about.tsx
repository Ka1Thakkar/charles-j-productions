...
const About = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center py-20">
            <div className="flex xl:flex-row flex-col min-h-[50vh] items-center md:px-32 gap-10 md:gap-10 py-20 px-10 justify-between transition-all ease-in-out">
                <div className="xl:w-6/12 transition-all ease-in-out">
                ...
                <div className={subheadingFont.className + ' xl:w-6/12 transition-all ease-in-out'}>
                    <h1 className="uppercase text-[#FFE812] font-extrabold text-4xl pb-5">
                        About Us
                    </h1>
