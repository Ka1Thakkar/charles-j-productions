...
const History = () => {
    return (
        <div className={subheadingFont.className + ' flex flex-col items-center justify-center min-h-screen px-10 md:px-32 py-20 text-[#FFE812] transition-all ease-in-out scroll-smooth'}>
            ...
            <p className="text-white text-3xl font-light mb-20">
            ...
            <Link href={"#crew"} scroll replace>
                <div role="button" className="text-white text-xl font-semibold border-[#FFE812] border-2 py-2 px-5 rounded-full hover:bg-[#FFE812] hover:text-black transition-all ease-in-out">
                    Meet the Crew
                </div>
            </Link>
        </div>
